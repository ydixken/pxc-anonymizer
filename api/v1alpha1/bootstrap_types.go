...
type BootstrapStatus struct {
	...
	// conditions represent the current state of the Bootstrap resource.
...
type Bootstrap struct {
	...
	// spec defines the desired state of Bootstrap
	// +required
	Spec BootstrapSpec `json:"spec"`

	// status defines the observed state of Bootstrap
	// +optional
