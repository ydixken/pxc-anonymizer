...
// AnonymizationPolicySpec defines the desired state of AnonymizationPolicy
type AnonymizationPolicySpec struct {
	...
	// foo is an example field of AnonymizationPolicy. Edit anonymizationpolicy_types.go to remove/update
	// +optional
	Foo *string `json:"foo,omitempty"`
}

// AnonymizationPolicyStatus defines the observed state of AnonymizationPolicy.
type AnonymizationPolicyStatus struct {
	...
	// conditions represent the current state of the AnonymizationPolicy resource.
...
// AnonymizationPolicy is the Schema for the anonymizationpolicies API
