...
// AnonymizationPolicyReconciler reconciles a AnonymizationPolicy object
type AnonymizationPolicyReconciler struct {
	client.Client
	Scheme *runtime.Scheme
}

// +kubebuilder:rbac:groups=pxc-anonymizer.io,resources=anonymizationpolicies,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=pxc-anonymizer.io,resources=anonymizationpolicies/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=pxc-anonymizer.io,resources=anonymizationpolicies/finalizers,verbs=update

// Reconcile is part of the main kubernetes reconciliation loop which aims to
// move the current state of the cluster closer to the desired state.
// TODO(user): Modify the Reconcile function to compare the state specified by
// the AnonymizationPolicy object against the actual cluster state, and then
...
func (r *AnonymizationPolicyReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&pxcanonymizeriov1alpha1.AnonymizationPolicy{}).
