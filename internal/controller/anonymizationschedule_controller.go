...
// +kubebuilder:rbac:groups=pxc-anonymizer.io,resources=anonymizationschedules,verbs=get;list;watch;create;update;patch;delete
...
// the AnonymizationSchedule object against the actual cluster state, and then
...
func (r *AnonymizationScheduleReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&pxcanonymizeriov1alpha1.AnonymizationSchedule{}).
